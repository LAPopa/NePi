...
export default function UserRegistrationSuccessTest(){
    let navigate = useNavigate();
    return (
        <div className="container mx-auto h-screen pt-32 md:pt-0 px-6 z-10 flex items-center justify-between">
            <div
                className="container mx-auto px-6 flex flex-col-reverse lg:flex-row justify-between items-center relative">
