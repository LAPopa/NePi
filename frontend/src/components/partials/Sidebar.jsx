                        ...
                        <ul className="mt-3">
                                    ...
                                    <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname === '/' && 'bg-slate-900'}`}>
                                        <NavLink end to="/tickets/assign-operators"
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <span
                                                    className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Assign Operators</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                </> :
                            ...
                            {localStorage.getItem("roles") === "ROLE_OPERATOR" || localStorage.getItem("roles") === "ROLE_ADMIN" ?
                                <>
                                    {/* Resolve Tickets */}
                                    <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname === '/' && 'bg-slate-900'}`}>
                                        <NavLink end to="/tickets/resolve-ticket"
                                                 className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname === '/' && 'hover:text-slate-200'}`}>
                                            <div className="flex items-center">
                                                <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                                    <path
                                                ...
                                                <span
                                                    className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Resolve Tickets</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                </> : <></>
