            ...
            <div className="flex h-max overflow-hidden">
                ...
                <div className="container  px-2 sm:px-8 max-w-3xl">
                    <div className="py-8">
                        ...
                        <div className="inline-block mt-3 ml-5 min-w-max shadow rounded-lg overflow-hidden">
                            <table className="min-w-full leading-normal">
                                <thead>
                                <tr>
                                    <th scope="col"
                        ...
                        <section className="max-h-screen max-w-screen-md ml-6 bg-blue-300 bg-opacity-50">
                            <form className="container max-w-2xl mx-auto shadow-md md:w-3/4 mb-10"
                                  method="POST" onSubmit={onSubmit}>
                                <div
                                    className="items-center w-full p-4 space-y-4 text-black md:inline-flex md:space-y-0">
                                    <h2 className="max-w-sm mx-auto md:w-1/3 text-lg mb-20">
                                        Assign operator
                                    </h2>
                                    <div className="max-w-sm mx-auto space-y-3 md:w-2/3">
                                        ...
                                        <div className=" relative ">
                                            <input type="text" id="user-info-first-name"
                                                   className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-800 placeholder-gray-500 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                        ...
                                        <div className="max-w-sm mx-auto md:w-1/4 pb-3">
                                            <button type="submit"
