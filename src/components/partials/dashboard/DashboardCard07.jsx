  ...
  return (
    <div className="col-span-full xl:col-span-8 bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        <h2 className="font-semibold text-slate-800">Top Activity</h2>
      </header>
      <div className="p-3">
          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                ...
                <th className="p-2">
                  <div className="font-semibold text-center">Tickets</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Flags</div>
                </th>
                {/*<th className="p-2">*/}
            ...
            <tbody className="text-sm font-medium divide-y divide-slate-100">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center">Waterworks</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-500">23</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center">WonderWater</div>
                </td>
                <td className="p-2">
